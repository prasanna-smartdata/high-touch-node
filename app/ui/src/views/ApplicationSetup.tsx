...
function AppDetails(prop : any) {
    ...
    function showFooter() { // document.getElementById("form1card")?.setAttribute("style", "padding-bottom: 0%");
    ...
    function showErroFooter() { // document.getElementById("form1card")?.setAttribute("style", "padding-bottom: 0%");
    ...
    return (
        <div className="slds-form-element slds-border_bottom slds-border_left slds-border_right">
            <div style={
                    ...
                    <div className="slds-notify_container slds-is-relative"
                        ...
                        <div className="slds-notify slds-notify_toast slds-theme_success" role="status">
                            ...
                            <div className="slds-notify__content">
                                <h2 className="slds-text-heading_small ">SFMC App Credentials Verified
                                </h2>
                            </div>
                ...
                <div id="errorfoot" className="slds-is-collapsed"
                    style={
                        {paddingTop: "0%"}
                }>
                        ...
                        <div className="slds-notify slds-notify_toast slds-theme_error" role="status">
                            ...
                            <div className="slds-notify__content">
                                <h2 className="slds-text-heading_small ">
                                    Verification failed.Please check the credentials</h2>
                            </div>
                            <div className="slds-notify__close">
                                <button onClick={
                                        (e) => {
                            ...
                            <div>
                                <div className="slds-col slds-size_2-of-6 slds-grid_pull-padded">
                                    <div className="slds-col_padded">
                                        <div className="slds-col_padded">
                                            <Input aria-describedby="error-4" id="unique-id-4" required
                                                onChange={getcid}
                                    ...
                                    <br/>
                                    <div className="slds-col_padded slds-m-center_none">
                                        <div className="slds-col_padded">
                                            <Input aria-describedby="error-4" id="unique-id-5" label="Client Secret" required placeholder="Enter Secret Key"
                                                onChange={getsecret}/>
                                        </div>
                                    ...
                                    <div className="slds-align_absolute-center"
                                        ...
                                        <Button variant="brand" name="verify" label="Verify My Account"
